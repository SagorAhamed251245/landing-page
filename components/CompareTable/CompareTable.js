...
const CompareTable = () => {
    return (
        <section className='table-box' style={{marginTop:"120px"}}>
           <div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className='blue-row'><img src='\images\svg\tabtik\vuesax\linear\vuesax\linear\tick-circle.svg'/></td>
                            <td style={{textAlign:"center"}} className='white-row'><img src='\images\svg\Ads Landing page\vuesax\linear\vuesax\linear\blacktik.svg'/></td>
                        </tr>
                        <tr>
